...
\section{The robot}
\include{Chapters/1_introduction/sections/the robot}
\label{The Slider}

\section{Spacecraft Control}
\include{Chapters/1_introduction/sections/spacecraft_control}

\section{Fault-Tolerant Control}
\include{Chapters/1_introduction/sections/fault-tolerant-control}

\section{Objective}
\include{Chapters/1_introduction/sections/objective}

\section{Scope}
\include{Chapters/1_introduction/sections/scope}

\section{Disposition}
\include{Chapters/1_introduction/sections/disposition}
