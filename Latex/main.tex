...
\setlength{\marginparwidth}{2.5cm} % tweak 2.2–3.0cm as needed
...
\input{Chapters/2_background/background}
...
\input{Chapters/3_theory/theory}


\makechapter{Method}{Method}{Method\label{method}}
\input{Chapters/4_method/method}
...
\input{Chapters/6_analysis/analysis}
...
\input{Chapters/7_cont_work/contd_work}
